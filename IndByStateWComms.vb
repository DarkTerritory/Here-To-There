...
Public Class IndByStateWComms
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Here_To_There.IndByStateWComms.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedIndByStateWComms
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As IndByStateWComms = New IndByStateWComms
        rpt.Site = Me.Site
        Return rpt
    End Function

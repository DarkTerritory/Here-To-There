...
Public Class TrainListByID
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Here_To_There.TrainListByID.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTrainListByID
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TrainListByID = New TrainListByID
        rpt.Site = Me.Site
        Return rpt
    End Function
